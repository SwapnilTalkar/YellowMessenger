...
data class UserResponse (
    ...
    @SerializedName("incomplete_results") val isResultComplete: Boolean? = null,
    @SerializedName("items") val userList: ArrayList<User>? = null,
)
...
data class User(
    ...
    @SerializedName("site_admin") val siteAdmin: String? = null,
